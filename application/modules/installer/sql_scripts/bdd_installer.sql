...
CREATE  TABLE IF NOT EXISTS `wc_form_field` (
  ...
  `name` VARCHAR(100) NOT NULL ,
  `description` VARCHAR(250) NULL ,
  `type` ENUM('textfield', 'emailfield', 'textarea', 'radiobutton', 'dropdown','checkbox','comment','file') NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `wc_ontology` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `original` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `semiotic` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
