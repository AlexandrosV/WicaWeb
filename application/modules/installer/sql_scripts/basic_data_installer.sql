...
(5, '12 Columns', 'sectemplate.phtml', 12, 'both'),
(6, 'Carrousel', 'seccarousel1.phtml', 1, 'section'),
(7, 'Login template', 'logintemplate.phtml', 1, 'both');
...
(11, 'Ontology', 'Ontology external module', 'active', 'ontology', 'ontology.png','ontology.phtml');
--
...
--
-- Populate table `wc_ontology`
--

INSERT INTO `wc_ontology` (`id`, `original`, `semiotic`,`section_id`,`parent_id`,`level`) VALUES
(1, 'Section', '', NULL,NULL,NULL);